...
then
  ...
  # Cek apakah input adalah angka (atomic number)
  if [[ $1 =~ ^[0-9]+$ ]]
  then
    ...
    # Jika bukan angka, cek apakah input adalah String (Symbol atau Name)
  ...
  then
    ...
    # Parse hasil query (dipisahkan oleh tanda | secara default di psql -t --no-align)
